        ...
        <div className="flex items-center gap-2 sm:gap-4">
            ...
            >
                {isAuthenticated && userInitial ? (
                    <div className="w-8 h-8 bg-gradient-to-br from-primary-500 to-primary-700 rounded-none flex items-center justify-center text-white text-xs font-bold shadow-neon group-hover:shadow-neon-hover">
                        {userInitial}
                    </div>
                ) : (
            ...
            <button
                onClick={onCartClick}
                className="relative p-2 text-gray-300 hover:text-primary-500 hover:bg-gray-800 rounded-none transition-all duration-300 group"
