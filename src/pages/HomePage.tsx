...
export default function HomePage() {
  ...
  // SEO Implementation
  useSEO({
    title: t('seo.home.title') || 'Carré Sport - Équipements Sportifs Premium au Maroc',
    description: t('seo.home.description') || 'Le N°1 des équipements sportifs au Maroc. Matériel de fitness, musculation et vêtements de sport. Livraison partout au Maroc.',
    url: window.location.origin,
    canonical: window.location.origin,
    type: 'website',
    keywords: t('seo.home.keywords') || 'sport maroc, matériel fitness casablanca, musculation rabat, équipement sportif',
    structuredData: {
